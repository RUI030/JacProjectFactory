...
- create_project
  ...
  inputs:
    name: string
    client_name: string
  Jac form: function   # def:pub — pure create, no traversal
  purpose: Create a new project record in the system with the provided name and client name.
  inputs:
    name: string
    client_name: string
  output: object
...
- list_projects
  Jac form: function   # def:pub — pure list query, no traversal
...
- stop_timer
  Jac form: function   # def:pub — pure update, no traversal
